...
## Run settings ##
readonly num_threads=(10 11 12 13 14 15 16)	# OMP_NUM_THREADS numbers to use
readonly num_repeats=3		# Number of times to repeat runs for each set of variables
declare -ir num_repeats_x=30	# Number of repeats of basis in x dirn
declare -ir num_repeats_y=60	# Number of repeats of basis in y dirn
...
do
	...
	sed -r "2 s/[[:digit:]]*[[:blank:]]+[[:digit:]]*[[:blank:]]+[[:digit:]]*/$num_repeats_x $num_repeats_y $i/" \
